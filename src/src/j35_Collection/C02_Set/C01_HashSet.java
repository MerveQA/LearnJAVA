...
public class C01_HashSet {
    ...
    Set: 1) unique(benzersiz tek) elemanlardan olusur, Set'lerin icinde bir eleman sadece bir kere kullanilabilir.
         ...
         Set --> HashSet:    1) HashSet, duplication’a(tekrarlı eleman) izin vermez.
            ...
            TreeSet:         1) TreeSet tekrarli eleman kabul etmez, cunku Set'dir.
                             ...
                             AHAN DA TRİCK :TreeSet "null" object'ini eleman olarak kullanilamaz.
         ...
         .retainAll(collection1);-->collection1’nin elemanlarinin disindaki tum elemanlari siler, silme islemi yapti ise true,
                                    yoksa false return eder. (kesişen ortak elemanları döndürür.)
    ...
    public static void main(String[] args) {
        ...
        HashSet<String> hs1 = new HashSet<>(Arrays.asList("Ercan","Yakup","Adem","Rukiye","Nur")); //Eleman atamasi yapilan HashSet
        ...
        System.out.println("hs2 = " + hs2);//[Asiktir, Basari, Gayrete]
        hs1.addAll(hs2);
        System.out.println("hs2 = " + hs2); // [Asiktir, Basari, Gayrete]
        System.out.println("hs1 = " + hs1);//[null, Ercan, Adem, Asiktir, Kevser, Basari, Nur, Yakup, Rukiye, Gayrete]

        // remove(); -> istenen eleman setten silinir
        System.out.println("hs1.remove(\"asiktir\") = " + hs1.remove("asiktir")); // Olmayan eleman silinirse -> false
        System.out.println("hs1.remove(\"Asiktir\") = " + hs1.remove("Asiktir")); // Varolan eleman silinirse -> true
        System.out.println("hs1 = " + hs1); //[null, Ercan, Adem, Kevser, Basari, Nur, Yakup, Rukiye, Gayrete]
        ...
        //clear();
        hs1.clear(); // hs1`in tum elemanlari silindi.
        System.out.println("hs1.isEmpty() = " + hs1.isEmpty()); //true
        System.out.println("hs1 = " + hs1); // []

        //contains();
        System.out.println("hs2.contains(\"Basari\") = " + hs2.contains("Basari")); // true
        System.out.println("hs2.contains(\"javaNAZ\") = " + hs2.contains("javaNAZ")); // false

        //hashCode();
        System.out.println("hs2.hashCode() = " + hs2.hashCode()); // 119005232
