...
public class  C04_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        System.out.println("ldt = " + ldt); // 2022-10-25T23:20:53.988954100
        DateTimeFormatter dtf= DateTimeFormatter.ofPattern("dd - MMMM - YY"); // 25 - Ekim - 22
        System.out.println("dtf.format(ldt) = " + dtf.format(ldt));

        DateTimeFormatter dtf1= DateTimeFormatter.ofPattern("hh:mm:ss a");
        System.out.println("dtf1.format(ldt) = " + dtf1.format(ldt)); // 11:24:19 ÖS
