...
public class C01_InterfaceNotlar {
    /*
        INTERFACE....

        			INTERFACE ASLA BİR CLASS DEGİLDİR. INTERFACE INTERFACE'dir.

        1) Interface yapilarda concrete method asla creat! edilemezdi java 8`e kadar. sadece  abstract method'lar creat edilirdi.
           TRICK :)
           ...
           TRICK :)
           Concrete method’da “default”  keyword yerine “static” keyword de kullanılabilir
           ama hem “default” hem de “static” keyword  birlikte kullanılamaz…
           ? Buradaki “static” keyword interface özel bir keyword’dur aynı package’deki başka class’dan className ile method call edilemez.
        ...
        5) Interface'lerdeki tum member'lar public oldugu icin AccesModifier yazilmasa da public ile ayni islemi yapar.
           public void ayna(); --> ayni islemi yaparlar.
           void ayna(); --> ayni islemi yaparlar.
        ...
        7) Interface'lerde tum veriable'lar mutlaka final'dir.
           ...
           Final veriable'ler initialize edilmezse CTE verir.
        ...
        10)Interface yapilarda istenirse abstract olmayan concrete method creat edilebilir.
           ...
           e) Interface yapilarda "static" olarak creat edilen concrete method child class'ı ancak
              Datatype(interfaceName) ile call edilir.
