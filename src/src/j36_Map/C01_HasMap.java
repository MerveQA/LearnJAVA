...
public class C01_HasMap {
    public static void main(String[] args) {
        ...
        // map.put(); -> girilen key, value datayi map`e eleman olarak ekler
        hm.put("Amazon","296 Euro");
        hm.put(null,"200 Euro"); // key null degeri kabul eder
        hm.put(null,"222 Euro"); // tekrarli key degerine value update edilir. Ayni key kullanilirsa uzerine atama yapilir.
        hm.put("Ebay",null); // value degeri null atanabilir.
        hm.put("Saturn","300 Euro");
        hm.put("Vatan","111 Euro");
        hm.put("Apple Store","333 Euro");
        hm.put("Apple Store","500 Euro"); // Apple Store key`deki value 333 iken 500 Euro olarak update edildi
