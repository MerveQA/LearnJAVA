...
public class C11_putIfAbsent {
    public static void main(String[] args) {
        ...
        //                       girilen key map`te var ise value return eder
        ...
        System.out.println("hm.putIfAbsent(\"ebik\",\"gabik\") = " + hm.putIfAbsent("ebik", "gabik")); // null
        System.out.println("hm.putIfAbsent(\"Ebay\",\"JavaNAZ\") = " + hm.putIfAbsent("Ebay", "JavaNAZ")); // 234 Euro
        // Ebay key oldugu icin ebay key`e ait value 234 Euro return eder

        System.out.println("hm: " + hm);
        //{ebik=gabik, Apple Store=333 Euro, Saturn=300 Euro, Ebay=234 Euro, MediaMarkt=183 Euro, Amazon=296 Euro, Vatan=111 Euro}
