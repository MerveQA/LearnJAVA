...
public class C08_equals_equalsIgnoreCase {
    public static void main(String[] args) {
        ...
        */
        ...
        String s3=new String("songul hanim"); // obje non-primitive.> heap memory
        String s4=new String("songul hanim"); // obje non-primitive.> heap memory

        System.out.println(s1 == s2); // true
        System.out.println(s1.equals(s2)); // true
        System.out.println(s3 == s4); // false herseyine bakar. heap`de farkli referanslara sahip
        System.out.println(s3.equals(s4)); // false sadece karakterlere bakar
